...
<div>
    <a href="{{ URL::to('admin/all-banks')  }}" class="btn btn-success">
        <i class="fa fa-university"></i>   All Banks</a>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light">{{ __('Add New Blood Bank') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('admin/add-bank') }}" aria-label="{{ __('Add New Blood Bank') }}">
                        @csrf
