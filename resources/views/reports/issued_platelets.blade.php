...
<head>
    <title>Issued platelets pdf report</title>
...
<h3 style="color: red">Platelets Issued</h3>
<table class="table">
    ...
    <tr>
        ...
        <td>{{ Carbon\Carbon::create($platelet->expiry_date)->diffInDays($platelet->donation_date)}}</td>
    </tr>

    @empty
    <tr>
        <td colspan="4">No Platelets issued.</td>
    </tr>
    @endforelse
</table>
