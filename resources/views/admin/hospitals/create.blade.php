...
<div>
    <a href="{{ URL::to('admin/hospitals')  }}" class="btn btn-success">
        <i class="fa fa-university"></i>   All Hospitals</a>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light">{{ __('Add New Hospital') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/hospital/add') }}" aria-label="{{ __('Add New Hospital') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ url('admin/hospitals') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
