...
<head>
    <title>Discarded platelets pdf report</title>
...
<h3 style="color: red">Platelets Discarded</h3>
<table class="table">
    ...
    <tr>
        ...
        <td>{{ Carbon\Carbon::create($platelet->expiry_date)->diffInDays($plasma->donation_date)}}</td>
    </tr>
