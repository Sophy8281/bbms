                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('staff/rbc/store/'.$processed_rbc->id) }}" aria-label="{{ __('Add RBC to Stock') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bag_serial_number" type="text" class="form-control @error('bag_serial_number') is-invalid @enderror" name="bag_serial_number" value="{{ $processed_rbc->rbc_bag_no}}" required autocomplete="bag_serial_number" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="group_id" type="text" class="form-control @error('group_id') is-invalid @enderror" name="group_id" value="{{ $processed_rbc->group->name}}" required autocomplete="group_id" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select  id="refrigerator_id" type="text" class="form-control @error('refrigerator_id') is-invalid @enderror" name="refrigerator_id">
                                    <option value="">Select Refrigerator to Store to</option>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ url('staff/rbc') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
