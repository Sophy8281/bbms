...
class CreateDiscardedPlateletsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('discarded_platelets', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('discarded_platelets');
    }
}