...
@section('content')
<div>
    <a href="{{ URL::to('staff/all-freezers')  }}" class="btn btn-success">
        <i class=""></i>   All Freezers</a>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('staff/add-freezer') }}" aria-label="{{ __('Add New Freezer') }}">
                        @csrf
