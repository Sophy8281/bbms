    ...
    <div class="panel-body">
        <table id="example" class="table table-responsive table-hover">
            ...
            <tr>
                <td>{{ $agitator->id }}</td>
                <td>
                    <a style="text-decoration:underline;color:blue" href="{{ url('admin/agitator/show/'.$agitator->id) }}">{{ $agitator->name }}</a>
                </td>
                ...
                <td>
                    ...
                    <a href="{{ url('admin/agitator/delete/'.$agitator->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete {{ $agitator->name }}?')"><i class="fa fa-trash"></i> Delete</a>
                </td>
            </tr>
            @endforeach
        </table>
