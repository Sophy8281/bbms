...
@section('content')
<div>
    <a href="{{ URL::to('admin/all-refrigerators')  }}" class="btn btn-success">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/add-refrigerator') }}" aria-label="{{ __('Add New Refrigerator') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ url('admin/all-refrigerators') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
