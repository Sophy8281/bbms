    ...
    $(document).ready(function(){
        $('#example').DataTable({
            ...
            buttons: [
                ...
                {extend: 'excel', className: 'btn btn-primary btn-outline btn-lg', text:'<i class="fa fa-file-excel"></i>'},
                {extend: 'pdf', title: 'Donors',  className: 'btn btn-primary btn-outline btn-lg', text:'<i class="fa fa-file-pdf"></i>'},
                {extend: 'print', title: 'Donors',className: 'btn btn-primary btn-outline btn-lg', text:'<i class="fa fa-print"></i>',
