...
{{-- <div>
    <a href="{{ URL::to('staff/platelets')  }}" class="btn btn-success">
        <i class=""></i>   Platelets in Stock</a>
</div> --}}
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('staff/platelets/add') }}" aria-label="{{ __('Add Platelets to Stock') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select  id="agitator_id" type="text"  name="agitator_id">
