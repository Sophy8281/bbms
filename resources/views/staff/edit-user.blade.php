...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="{{ url('staff/user/edit/'.$user->id) }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <p class="hint--top" data-hint="Gender" id="input-field">
                    ...
                    <select type="text" name="gender" class="form-control @error('gender') is-invalid @enderror" required>
                        @if ($user->gender)
            ...
            <a href="{{ url('staff/all-users') }}" class="btn btn-danger">Cancel</a>
        </form>
    </div>
</div>
@stop
